...
import { ArrowRight, Container, Section, SectionHead } from "./ui";
          ...
          {dict.hooks.items.map((item, i) => (
            <Reveal key={item.quote} delay={i * 70}>
              <Link
                ...
                className="group flex h-full flex-col rounded-card border border-line bg-paper p-6 transition-colors hover:border-brand sm:p-7"
              >
                <p className="text-lg font-semibold text-balance text-ink sm:text-xl">
