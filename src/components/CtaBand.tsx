...
export default function CtaBand({ dict, locale }: { dict: Dict; locale: Locale }) {
  ...
  return (
    <Section tone="brand" panelClassName="relative overflow-hidden">
      {/* Скобка из логотипа как водяной знак — жест бренда, не нумерация. */}
      <span
        aria-hidden="true"
        className="pointer-events-none absolute -right-4 -bottom-28 font-mono text-[18rem] leading-none text-white/6 select-none"
      >
        {"}"}
      </span>
