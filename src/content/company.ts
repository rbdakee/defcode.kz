...
export const company = {
  ...
  /**
   * Подпись в футере. Сейчас это просто бренд — организационно-правовую
   * форму и ИИН закон в футере публиковать не обязывает.
   */
  legalName: "Defcode" as string | null,
  bin: null as string | null, // без БИН — оставляем пустым, блок скроется
